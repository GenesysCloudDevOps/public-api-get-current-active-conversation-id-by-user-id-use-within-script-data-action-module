A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get Current Active Conversation ID by User ID
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-current-active-conversation-id-by-user-id-use-within-script-data-action-module.git?ref=v1.0.0"
    action_name        = "Get Current Active Conversation ID by User ID"
